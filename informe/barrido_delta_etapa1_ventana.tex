...
\large Barrido en $\delta$, etapa 1 --- caso \emph{ventana}, $\epsilon = 0.71$}
...
\paragraph{El caso.} $\epsilon = kh = 0.71$ reproduce el régimen \emph{ventana} del
...
\paragraph{Parámetros.} Caja $2\pi\times2\pi\times0.5000$, $\nu = \num{1.000e-02}$
...
0.3, 1, 3, 6, 10, 15 en la ventana; el $\delta$ de la tabla es el medido ahí.
...
\midrule
\num{1.92e-02} & 0.292 & 1.00048 & 1.0010 & 0.292 & 1.00048 & 1.0010 \\
\num{6.42e-02} & 0.971 & 1.00535 & 1.0036 & 0.971 & 1.00535 & 1.0036 \\
\num{1.93e-01} & 2.84 & 1.04405 & 1.0248 & 2.84 & 1.04406 & 1.0248 \\
\num{3.85e-01} & 5.32 & 1.14245 & 1.0826 & 5.32 & 1.14297 & 1.0830 \\
\num{6.42e-01} & 8.02 & 1.26789 & 1.1757 & 7.92 & 1.27000 & 1.1834 \\
\num{9.62e-01} & 10.5 & 1.32467 & 1.2591 & 10.1 & 1.31277 & 1.2792 \\
\bottomrule
\end{tabular}
...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{../salidas/figuras/f7_barrido_delta_ventana.pdf}
...
32.47\,\%, por encima de la barra experimental (7.3\,\%), y las dos mallas
coinciden dentro de 1.19\,\%, de modo que no es un artefacto de resolución. La
